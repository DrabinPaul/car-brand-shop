    ...
    const handleAddToCart = () => {
        fetch("http://localhost:5000/cart", {
            ...
            .then((data) => {
                console.log(data)
                if (data.insertedId) {
                    Swal.fire("Product added to Mycart!");
                }
            });
    };
        ...
        <div className="max-w-6xl mx-auto">
            ...
            <div>
                <div className="items-center flex justify-center mt-10">
                    <img className="h-[300px] lg:h-[500px]  lg:object-cover rounded-t-lg mb-5 p-5 lg:p-0 " src={productDetails.photoUrl} alt="" />
                </div>
                ...
                <div className=" flex justify-center">
                    <button onClick={handleAddToCart} className="btn bg-[#1f1f1f] text-[#EA001E] w-1/3 mb-10">Add To Cart</button>
                </div>
